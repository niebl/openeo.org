...
[GitHub releases page](https://github.com/Open-EO/openeo-qgis-plugin/releases). First, download the zip `"openeo_plugin.zip"` archive. 
...
3. The **latest version** (or a branch of your choice) is accessible through the [GitHub repository](https://github.com/Open-EO/openeo-qgis-plugin).
